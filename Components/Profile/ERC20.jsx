              ...
              <div class="login-form signup-form">
                ...
                <div id="contactForm" class="log-form">
                  <input
                    ...
                    class="form-control"
                    placeholder="Name"
                    required onChange={(e) => handleTokenInfo("name", e)}
                  />
                  ...
                  <input 
                    ...
                    class="form-control"
                    placeholder="Symbol"
                    required onChange={(e) => handleTokenInfo("symbol",e)}
                  />
                  ...
                  <input
                    ...
                    required onChange={(e) => handleTokenInfo("supply",e)}
                  />
                  ...
                  <div class="sign-icon">
                    <div class="acc-not">
                      with minimum fee of <a> 1 SepoliaETH</a>
                    </div>
                  </div>
                </div>
              </div>
